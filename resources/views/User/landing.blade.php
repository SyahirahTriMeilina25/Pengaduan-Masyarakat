...
<section class="header">
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div class="container">
            <div class="container-fluid">
                <img src="{{ asset('images/logo.png') }}" alt="Logo" width="50" height="50" class="mb-3" style="margin-right: 6px">
    ...
    <div class="text-center">
        ...
        <p class="italic text-white mb-5">Sampaikan Laporan atau Pengaduan Anda Langsung Pada Form Ini </p>
    </div>
        ...
        <div class="content shadow">
            ...
            @else
                <div class="alert alert-warning mt-3" style="text-align: center">
                    Anda harus <a href="#" data-toggle="modal" data-target="#loginModal">Login</a> atau<a href="{{route('pekat.formRegister')}}" > Daftar </a>terlebih dahulu
                    untuk mengirim laporan pengaduan
                </div>
            @endif
        </div>
    </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Puskesmas Melur • All rights reserved</p>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="mt-3">Login terlebih dahulu</h3>
                ...
                @endif
                <a href="{{ route('pekat.index') }}" class="btn btn-warning text-white mt-3 mb-3" style="width: 100%">Kembali ke Halaman Utama</a>
                <a href="{{route('admin.formLogin')}}" class="text-primary mt-5">Login as Admin</a>
            </div>
        </div>
    </div>
</div>
