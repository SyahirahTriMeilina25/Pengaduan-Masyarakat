            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="#" onclick="confirmLogout()"style="text-decoration: underline">{{ Auth::guard('masyarakat')->user()->nama }}</a>
                        </li>
                    </ul>
                    @else
                    <ul class="navbar-nav text-center ml-auto">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <!-- Form Logout -->
                <form id="logoutForm" action="{{ route('pekat.logout') }}" method="POST">
                    @csrf
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #008238;" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
